...
- ```podman image inspect registryUrl``` &rarr; shows information about the image
...
- ```podman imgae prune -a``` &rarr; clean dangling and unused images (use -f option to force and avoid interactive prompt)
